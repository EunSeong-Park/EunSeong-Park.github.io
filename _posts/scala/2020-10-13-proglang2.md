...
$$\begin{aligned}
trans(n)(\rho) & = n \\
trans(x)(\rho) & = \#n\;(\text{n is the first position of x in }\rho) \\
trans(E_1 \pm E_2)(\rho) & = trans(E_1)(\rho) \pm trans(E_2)(\rho) \\  
trans(iszero\;E)(\rho) & = iszero\;trans(E)(\rho) \\
trans(E_1\;thenE_2\;else\;E_3)(\rho) & = if\; trans(E_1)(\rho)\;then\;trans(E_2)(\rho)\;else\;trans(E_3)(\rho) \\
\end{aligned}
$$